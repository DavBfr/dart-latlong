...
void main() {
  ...
  group('Distance', () {
    ...
    test('> Radius', () {
      expect((Distance()).radius, EARTH_RADIUS);
      expect((Distance.withRadius(100.0)).radius, 100.0);
    }); // end of 'Radius' test

    test('> Distance to the same point is 0', () {
      final Distance compute = Distance();
      final LatLng p = LatLng(0.0, 0.0);
    ...
    test('> Distance between 0 and 90.0 is 10001.96572931165 km ', () {
      final Distance distance = Distance(roundResult: false);
      final LatLng p1 = LatLng(0.0, 0.0);
      final LatLng p2 = LatLng(90.0, 0.0);
    ...
    test('> distance between 0,-180 and 0,180 is 0', () {
      final Distance distance = Distance();
      final LatLng p1 = LatLng(0.0, -180.0);
      final LatLng p2 = LatLng(0.0, 180.0);
    ...
    group('Haversine - not so accurate', () {
      test('> Test 1', () {
        final Distance distance = Distance(calculator: const Haversine());
  ...
  group('Bearing', () {
    ...
    test('bearing between 0,-90 and 0,90 is -90 degree', () {
      final Distance distance = const Distance();
      final LatLng p1 = LatLng(0.0, -90.0);
      final LatLng p2 = LatLng(0.0, 90.0);
